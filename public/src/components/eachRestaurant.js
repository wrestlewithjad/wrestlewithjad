    ...
    return (
      ...
      <div className = 'eachRestaurant'>
     	<div style={revStyle}>
      	...
      	<div style={nameStyle}>
      		<p><a href = {this.props.restaurant_info.MENU_WEBSITE} target='_blank'>  {this.props.restaurant_info.NAME}</a></p>
      	</div>
		<div style={pstyle}>
			...
			{/* Creates a Vegetarian, GF, and/or tag on each component*/}
			<p>{this.props.restaurant_info.PRICE} ⋅ {this.props.restaurant_info.TYPE} ⋅ {this.props.restaurant_info.SPEED} <span style={tags}>{ this.props.restaurant_info.Alcohol === "YES" ? ' 🍸Alcohol ' : null}<span style={health}>{ this.props.restaurant_info.GF ? ' 🌱GF  ' : null} { this.props.restaurant_info.Vegetarian ? ' 🌱Vegetarian  ' : null}</span></span></p>
		</div>
